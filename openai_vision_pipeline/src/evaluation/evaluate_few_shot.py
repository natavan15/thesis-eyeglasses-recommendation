...
INPUT_FILE = "openai_vision_pipeline/results/few_shot_raw100.xlsx"
OUTPUT_TXT = "openai_vision_pipeline/results/few_shot_raw100_evaluation.txt"
OUTPUT_CM = "openai_vision_pipeline/results/few_shot_raw100_confusion_matrix.png"
...
plt.ylabel("True")
plt.title("Few-shot ChatGPT RAW 100 Confusion Matrix")
plt.tight_layout()
